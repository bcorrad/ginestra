...
def objective(trial, train_loader, val_loader, num_features, num_classes, config_idx):
...
def optuna_grid_search(train_loader, val_loader, test_loader, num_features, num_classes):
    ...
    def wrapped_objective(trial):
        ...
        return objective(trial, train_loader, val_loader, num_features, num_classes, config_idx)
