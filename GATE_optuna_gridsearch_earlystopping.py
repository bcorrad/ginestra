...
EXPERIMENT_FOLDER = initialize_experiment(f"gate_{DATASET_ID}", TARGET_TYPE, BASEDIR)

def objective(trial, train_loader, val_loader, test_loader, in_channels, out_channels, edge_dim, fingerprint_length, config_idx, n_config):
...
def optuna_grid_search(train_loader, val_loader, test_loader, in_channels, out_channels, edge_dim, fingerprint_length):
    ...
    def wrapped_objective(trial):
        ...
        return objective(trial, train_loader, val_loader, test_loader, in_channels, out_channels, edge_dim, fingerprint_length, config_idx, n_config)
