...
class MLP2(nn.Module):
    def __init__(self, input_channels=6144, hidden1=6144, hidden2=3072, hidden3=1536, dropout=0.2, num_categories=10):
        super(MLP2, self).__init__()
        self.fc1 = nn.Linear(input_channels, hidden1)
        self.bn1 = nn.BatchNorm1d(hidden1)
        self.fc2 = nn.Linear(hidden1, hidden2)
        self.bn2 = nn.BatchNorm1d(hidden2)
        self.fc3 = nn.Linear(hidden2, hidden3)
        self.bn3 = nn.BatchNorm1d(hidden3)
        self.fc4 = nn.Linear(hidden3, hidden3)
        self.dropout = nn.Dropout(dropout)
        self.fc6 = nn.Linear(hidden3, num_categories)
